...
from langchain.schema import Document  # LangChain的文档对象
from langchain_core.runnables import RunnableConfig  # LangChain链的配置
from langchain.schema import StrOutputParser  # 用于从LLM输出中解析字符串

# 1.3 导入项目内部模块，复用RAG系统的核心组件。
from Chapter3_RAG.SmartRecruit.config import config
from milvus_model.hybrid import BGEM3EmbeddingFunction
from Chapter3_RAG.SmartRecruit.rag.chain import llm, retriever, REWRITE_PROMPT, ANSWER_PROMPT, _format_docs
